...
"""Per-operation access log for the dfkv vLLM connector.

Mirrors the format used by dfkv's HiCache / dingofs vfs access log and the
LMCache connector's access log, one line per operation::
...
e.g.::
    ...
    batch_put_sg(1 keys, 65536 bytes) : ok=1/1 <0.000821>
    batch_exist(64 keys) : present=18/64 <0.000412>
